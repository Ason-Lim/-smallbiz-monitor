...
def init_db():
    ...
    # Check if table has data. If less than 15 items, re-seed to apply new regions automatically.
    ...
    if count < 15:
        ...
        seed_data = [
            ...
            # --- 신규 추가 요청된 도·시·군 및 경제진흥원 씨드 데이터 ---
            (
            ...
            (
                ...
                "2026 경북 소상공인 온라인 판로개척 및 마케팅 지원",
                "대형 쇼핑몰(네이버, 쿠팡 등) 입점 교육, 홍보 상세페이지 무료 제작 및 키워드 마케팅 비용 100만 원 지원",
                "https://www.gepa.kr", "2026-07-31", "업체당 최대 100만 원 간접 마케팅비 지원",
                "경상북도 내 사업자등록을 둔 e커머스 입점 희망 소상공인",
                "진흥원 홈페이지 신청 -> 서류 심사 -> 전문 대행사 매칭 -> 기획전 및 광고 실행 후 정산",
                "관리기관 위탁 지급", "경북경제진흥원 홈페이지 온라인 지원사업 신청 탭",
                "사업자등록증, 소상공인확인서, 국세 완납증명서, 통신판매업 신고증 사본",
                "054-470-8500 / 소상공인팀",
                "【경북경제진흥원 공고 제2026-105호】\n도내 우수 소상공인의 온라인 시장 진출 활성화와 브랜드 자생력 배양을 위하여 경상북도 예산으로 시행하는 e커머스 마케팅 지원사업 공고입니다.",
                "모집중"
            ),
            (
                "서울", "전체", "서울경제진흥원", "2026-06-11",
                "서울 소상공인 매장 디지털 전환 스마트 상점 기술 보급사업",
                "테이블오더, 대기 시스템, 무인 키오스크 등 매장 효율화 스마트 기술 설치 및 렌탈료 70% 지원",
                "https://sba.seoul.kr", "2026-07-25", "기술 도입비의 70% 보조 (최대 300만 원)",
                "서울특별시 소재 매장 내 스마트 기술 도입을 희망하는 소상공인",
                "SBA 홈페이지 신청 -> 심사 및 설치 진단 -> 기술 설치 후 70% 보조금 정산 지급",
                "관리기관 위탁 지급", "서울경제진흥원(SBA) 홈페이지 온라인 접수",
                "신청서, 기술 도입 계획서, 사업자등록증, 매장 내부 및 전경 사진",
                "02-2222-3788 / 스마트상점 지원팀",
                "【SBA 공고 제2026-89호】\n서울 영세 상인들의 디지털 전환 장벽 완화와 매장 운영 효율성을 극대화하기 위하여 '매장 디지털 전환 지원사업'을 공고하오니 소상공인분들의 많은 참여 바랍니다.",
                "모집중"
            )
        ]
